...
root.title("Update Student Details")
global tree
...
l_rno = Label(L_Frame, text= "Update Student Details", font=("Comic Sans MS", 20, BOLD))
l_rno.place(x=0,y=10)
...
sub = Button(L_Frame, text="Update", font=("Comic Sans MS", 14, BOLD), bg="light green", command=Register)
sub.place(x=0,y=510)
